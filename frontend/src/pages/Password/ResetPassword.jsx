    ...
    <div>
      ...
      >
        ...
        <form className="flex flex-col justify-center gap-6 rounded-lg p-4 text-gray-800 w-80 h-[26rem] shadow-[0_0_10px_black]">
          ...
          <button
            className="w-full bg-green-600 hover:bg-green-500 transition-all ease-in-out duration-300 rounded-md py-2 font-semibold text-lg cursor-pointer text-black"
            type="submit"
          >
            Reset Password
          </button>
