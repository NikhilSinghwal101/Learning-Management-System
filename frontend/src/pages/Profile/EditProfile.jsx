...
import { getUserData, updateProfile } from "../../redux/features/authSlice";
...
const EditProfile = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    // if (data?.user?.fullName.length < 5) {
    ...
    <div>
      <div className="flex items-center justify-center h-[100vh]">
        <form
          ...
          className="flex flex-col justify-center gap-5 rounded-lg p-4 text-gray-800 w-80 h-[26rem] shadow-[0_0_10px_black]"
        >
          <h1 className="text-center text-2xl font-semibold">Edit Profile Page</h1>
          ...
          <button
            className="w-full bg-green-500 hover:bg-green-600 transition-all ease-in-out duration-300 rounded-md py-2 font-semibold text-lg cursor-pointer text-white"
            type="submit"
          >
            Update Profile
          </button>
