...
export default function CreateCourse() {
  ...
  const handleFormSubmit = async (event) => {
    ...
    // if(isLoading) {
    //   toast.loading("Course is creating! Please Wait");
    // }

    toast.promise(
      dispatch(createCourse(formData)), 
      {
        pending: "Course is being created...",
        success: "Course created successfully! 🎉",
        error: "Failed to create the course. Try again.",
      }
    );
    ...
    setInput("");  // For empty the description
  };
