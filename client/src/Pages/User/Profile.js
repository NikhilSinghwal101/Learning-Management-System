        ...
        <div className="my-10 flex flex-col gap-4 rounded-lg p-4 text-gray-800 w-80 shadow-[0_0_10px_black]">
          ...
          <div className="flex items-center justify-between gap-2">
            <Link
              ...
              className="w-1/2 bg-yellow-600 hover:bg-yellow-700 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold cursor-pointer text-center text-black"
            >
            ...
            <Link
              ...
              className="w-1/2 border border-yellow-600 hover:border-yellow-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold cursor-pointer text-center text-gray-900"
            >
