    ...
    <Layout>
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
          ...
          <button
            className="w-full bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg cursor-pointer text-black"
            type="submit"
          >
            Update Profile
          </button>
